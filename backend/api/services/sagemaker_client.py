...
def invoke_strategy_model(endpoint_name: str, region: str, prompt: str) -> dict:
    """Use Bedrock for strategy analysis with demo fallback"""
    try:
        ...
        try:
            ...
            # Return demo response for hackathon demo
...
*Note: This response is generated using AWS Bedrock Claude 3 Haiku for the hackathon demo.*"""
            return {"text": demo_response, "source": "bedrock"}
