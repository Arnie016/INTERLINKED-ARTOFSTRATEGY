        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">OrgMind AI</h1>
                <p className="text-sm text-gray-500">Organizational Intelligence Platform</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {!isConnected ? (
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            ...
            <h2 className="text-lg font-semibold text-red-800 mb-2">Backend Not Connected</h2>
          ...
          <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    ...
                    className="px-3 py-1 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm flex items-center space-x-1"
                  >
                    {isGeneratingData ? (
                      <>
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm" style={{ height: '65vh' }}>
              <GraphVisualization
                data={graphData}
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm" style={{ height: '35vh' }}>
            ...
            <div className="p-4">
              ...
              {selectedEdge && (
                <div className="space-y-3">
                  <div>
                    <label className="block text-sm font-medium text-gray-700">ID</label>
                    <p className="text-sm text-gray-900 font-mono">{selectedEdge.id}</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700">Type</label>
      ...
      <footer className="bg-white border-t border-gray-200 mt-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm text-gray-500">
              Powered by Neo4j, Bedrock AI, and Cytoscape.js
            </div>
          </div>
        </div>
      </footer>
